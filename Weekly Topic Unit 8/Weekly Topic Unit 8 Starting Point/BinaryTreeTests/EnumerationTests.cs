...
namespace BinaryTreeTests
{
    ...
    public class EnumerationTests
    {
        ...
        [TestMethod]
        public void OneTestOfYourChoosing()
        {
            BinaryTree<int> tree = new BinaryTree<int>();
            ...
            tree.InOrderTraversal(item => Assert.AreEqual(expected[index++], item, "My Own Binary Tree"));
        }
        [TestMethod]
        public void InOrder_Delegate_Reverse_Sequence()
        {
            BinaryTree<int> tree = new BinaryTree<int>();
            ...
            tree.InOrderTraversal(item => Assert.AreEqual(expected[index++], item, "Inorder Delegate reverse sequence"));
        }
